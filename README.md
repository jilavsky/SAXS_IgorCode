...
**The current stable release version is April2019.** This release includes new tools - 3D aggregate model and 3D Two phase solid model. There is also tool for quatification of anisotropy (Hermansen orientation parameter, HOP). If you have any issues with this beta release, please report them ASAP to me. 
