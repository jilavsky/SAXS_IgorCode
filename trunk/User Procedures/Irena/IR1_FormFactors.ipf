...
//	SVAR FFParamPanelControls=root:Packages:FormFactorCalc:FFParamPanelControls
	...
	if(stringMatch(ctrlName,"FitP6Value"))
		SetVariable P6LowLim,disable=!(checked), win=FormFactorControlScreen
		SetVariable P6HighLim,disable=!(checked), win=FormFactorControlScreen
	endif
	if(stringMatch(ctrlName,"FitP7Value"))
		SetVariable P7LowLim,disable=!(checked), win=FormFactorControlScreen
		SetVariable P7HighLim,disable=!(checked), win=FormFactorControlScreen
	endif
	if(stringMatch(ctrlName,"FitP8Value"))
		SetVariable P8LowLim,disable=!(checked), win=FormFactorControlScreen
		SetVariable P8HighLim,disable=!(checked), win=FormFactorControlScreen
	endif
