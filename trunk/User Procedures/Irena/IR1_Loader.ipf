...
#include ":IR1_DataManipulation", version>=2.38
#include ":IR1_Desmearing", version>=2.04
...
#include ":IR1_GeneralGraph", version >=2.14
#include ":IR1_GeneralGraph2", version >=2.10
#include ":IR1_GraphStyling", version>=2.01
#include ":IR1_ImportData", version>=2.17
...
#include ":IR1_Sizes", version>=2.07
#include ":IR1_SupportFncts", version>=2.03
#include ":IR1_Unified_Fit_Fncts", version>=2.06
#include ":IR1_Unified_Fit_Fncts2", version>=2.03
#include ":IR1_Unified_Panel", version>=2.10
#include ":IR1_Unified_Panel_Fncts", version>=2.09
...
#include ":IR2_PanelCntrlProcs", version>=1.25
#include ":IR2_Reflectivity", version >=1.12
#include ":IR2_ScriptingTool", version>=1.12
#include ":IR2_SmallAngleDiff", version>=1.08
#include ":IR2_StructureFactors", version>=1.04
#include ":IR2_UniversalDataExport", version>=1.05
#include ":IR2L_NLSQFCalc", version>=1.05
#include ":IR2L_NLSQFfunctions", version>=1.11
#include ":IR2L_NLSQFmain", version>=1.08
