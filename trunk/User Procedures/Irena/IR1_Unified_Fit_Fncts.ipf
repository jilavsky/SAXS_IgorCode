...
Function IR2U_UnifAnalysisHelp()
	...
	if(V_Flag)
		...
		Notebook $nb text="Naiping Hu, Neha Borkar, Doug Kohls and Dale W. Schaefer, ÒCharacterization of Porous Materials Using Co"
		Notebook $nb text="mbined Small-Angle X-ray and Neutron Scattering TechniquesÓ, J Appl Cryst 2011)\r"
		Notebook $nb text="\r"
		Notebook $nb text="All of these can be analyzed by using ÒAnalyze resultsÓ tool. It can be called from the bottom of the Un"
		Notebook $nb text="ified main panel.  There are two options which data can be analyzedÉ Current Unified data in the Unified"
		Notebook $nb text=" fit tool or Unified results saved to any folder in the Igor experiment.\r"
		Notebook $nb text="\r"
		Notebook $nb text="\r"
		Notebook $nb text="User can output results of any analysis to either command line, the log book (Igor ÒnotebookÓ into which"
		...
		Notebook $nb fSize=-1, fStyle=-1
		Notebook $nb text="This is copied from the manuscript by Dale Schaefer É For details, please, check the manuscriptÉ It is a"
		...
		Notebook $nb text="Note, these models can be evaluated also for combination of Unified levelsÉ Only single level or ÒAllÓ i"
		Notebook $nb text="s allowed. If ÒAllÓ is used, Porod constant from level 1 is used, but invariant is calculated from all l"
		Notebook $nb text="evels togetherÉ \r"
		...
		Notebook $nb text="the Scattering contrast calculator to calculate these values. Please, NOTE thisÉ \r"
		...
		Notebook $nb text="le the method 5 does not, while method 5 requires knowledge of sample bulk densityÉ \r"
		Notebook $nb text=" \r"
	endif
end
//******************************************************************************************************************
