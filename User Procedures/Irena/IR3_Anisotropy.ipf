...
Function IR3N_AnisotropicSystemsPanel() 
	...
	PopupMenu PeakProfileShape,pos={120,220},size={380,21},proc=IR3N_AniSysPopMenuProc,title="Peak Profile shape :", help={"Select method to fit the peak profile "}
	PopupMenu PeakProfileShape,mode=2,popvalue=PeakProfileShape,value= #"\"Gauss;Lorenz;\""
	Button FitPeak,pos={125,250},size={150,20},proc=IR3N_AniSysButtonProc,title="Fit Peak", help={"Fit peak profile and calcualte parameters"}
	...
	SetVariable PeakCenterDegrees,pos={10,275},size={260,16},title="Peak Center [Degrees]",noproc, help={"Peak Center in Degrees"}, disable=2, format="%0.5g"
	...
	SetVariable WidthDegrees,pos={10,300},size={260,16},title="Peak Width [Degrees]",noproc, help={"Peak width in Degrees"}, disable=2, format="%0.4g"
	...
	SetVariable HOPAverage,pos={10,325},size={260,16},title="HOP (average)",noproc, help={"HOP"}, disable=2, format="%0.3g"
	...
	SetVariable HOPLeft,pos={10,350},size={260,16},title="HOP (left)",noproc, help={"HOP left of peak"}, disable=2, format="%0.3g"
	...
	SetVariable HOPRight,pos={10,375},size={260,16},title="HOP (right)",noproc, help={"HOP right of peak"}, disable=2, format="%0.3g"
	...
	SetVariable HOPAngleStart,pos={10,400},size={260,16},title="HOP start Angle [Degrees]",noproc, help={"HOP start angle in Degrees"}, disable=2, format="%0.3g"
	...
	SetVariable HOPAngleEnd,pos={10,425},size={260,16},title="HOP end Angle [Degrees]",noproc, help={"HOP end angle in Degrees"}, disable=2, format="%0.3g"

	Button SaveResults,pos={125,480},size={150,20},proc=IR3N_AniSysButtonProc,title="Save results (notebook)", help={"Store results and graph to notebook"}
