...
Function IR1P_GeneralPlotTool()
	...
	String ListOfWindowsToClose="GizmoControlPanel;Irena_Gizmo;GeneralGraph;plottingToolWaterfallGrph;IR1P_ControlPanel;IR1P_RemoveDataPanel;"
	ListOfWindowsToClose+="plottingToolWaterfallGrph;IR1P_ModifyDataPanel;IR1P_FittingDataPanel;IR1P_ChangeGraphDetailsPanelplottinggToolContourGrph;"
...
Function IR1P_MainCheckVersion()	
	...
	if(V_Flag)
		if(!IR1_CheckPanelVersionNumber("IR1P_ControlPanel", IR1PversionNumber))
			DoAlert /T="The plotting tool I panel was created by incorrect version of Irena " 1, "Plotting tool may need to be restarted to work properly. Restart now?"
			if(V_flag==1)
...
//		endif
		...
		if (IsAllAllRight)
			...
			//print "Added "+DFloc+" to plotting tool"
		else
	...
	switch( cba.eventCode )
		case 2: // mouse up
			...
			if(stringmatch(ctrlName,"GizmoDisplayGridLines"))
				if(checked)
					PauseUpdate
					ModifyGizmo/N=Irena_Gizmo ModifyObject=GPISurfaceData,objectType=surface, property={lineColorType,1}
					  ModifyGizmo/N=Irena_Gizmo ModifyObject=GPISurfaceData,objectType=surface, property={ lineColor,0,0,0,1}  
					  ModifyGizmo/N=Irena_Gizmo ModifyObject=GPISurfaceData,objectType=surface, property={ fillMode,3}	  
					DoUpdate
				else
					  ModifyGizmo/N=Irena_Gizmo ModifyObject=GPISurfaceData, objectType=surface, property={ fillMode,2}  
				endif
			endif
			if(stringmatch(ctrlName,"GizmoDisplayLabels")  )
				...
				if(checked)
						PauseUpdate
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes, property={0,axisLabel,1}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={8,axisLabel,1}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={2,axisLabel,1}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={0,axisLabelCenter,-0.5}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={8,axisLabelCenter,-0.5}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={2,axisLabelCenter,-0.5}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={0,axisLabelDistance,0.2}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={8,axisLabelDistance,0.2}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={2,axisLabelDistance,0.2}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={0,axisLabelScale,0.5}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={8,axisLabelScale,0.5}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={2,axisLabelScale,0.5}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={0,axisLabelRGBA,0,0,0,1}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={8,axisLabelRGBA,0,0,0,1}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={2,axisLabelRGBA,0,0,0,1}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={0,axisLabelText,GraphXAxisName}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={8,axisLabelText,"Data order"}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={2,axisLabelText,GraphYAxisName}  
						DoUpdate
				else
						PauseUpdate
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={0,axisLabelText," "}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={8,axisLabelText," "}  
						  ModifyGizmo/N=Irena_Gizmo ModifyObject=axes0,objectType=axes,property={2,axisLabelText," "}  
						DoUpdate
				endif
			endif
