...
//*****************************************************************************************************************
//*****************************************************************************************************************
Function IR3DM_CheckProc(STRUCT WMCheckboxAction &cba) : CheckBoxControl
...
Function IR3DM_ButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function IR3DM_SetVarProc(STRUCT WMSetVariableAction &sva) : SetVariableControl
...
Function IR3DM_PopMenuProc(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function IR3DM_ProcessDataFunction(variable HowMany)
...
Function IR3DM_GraphWindowHook(STRUCT WMWinHookStruct &s)
