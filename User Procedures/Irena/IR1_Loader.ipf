...
#include ":IR1_Sizes", version>=2.06
#include ":IR1_SupportFncts", version>=2.03
#include ":IR1_Unified_Fit_Fncts", version>=2.05
#include ":IR1_Unified_Fit_Fncts2", version>=2.02
#include ":IR1_Unified_Panel", version>=2.08
#include ":IR1_Unified_Panel_Fncts", version>=2.07
#include ":IR1_Unified_SaveExport", version>=2.01
#include ":IR1_UnifiedSaveToXLS", version>=2.01
#include ":IR2_dataMiner", version >=1.08
#include ":IR2_GelsTool", version>=4.06
#include ":IR2_PanelCntrlProcs", version>=1.21
#include ":IR2_Reflectivity", version >=1.1
#include ":IR2_ScriptingTool", version>=1.11
#include ":IR2_SmallAngleDiff", version>=1.07
#include ":IR2_StructureFactors", version>=1.03
#include ":IR2_UniversalDataExport", version>=1.03
#include ":IR2L_NLSQFCalc", version>=1.05
#include ":IR2L_NLSQFfunctions", version>=1.11
#include ":IR2L_NLSQFmain", version>=1.07
#include ":IR2L_NLSQFsupport", version>=1.13
#include ":IR2Pr_PDFMain", version>=1.04
#include ":IR2Pr_Regularization", version>=1.02
#include ":IR2_DWSGraphControls", version>=1
#include ":IR2_DWSgraph", version>=1
#include ":IR3_GuinierPorodModel", version>=0.9

//these are in different folders...
#include "::CanSAS:canSASXML_GUI", version>=1.02
#include "::CanSAS:canSASXML", version>=1.11

//#include "GeneticOptimisation", version>=1


#include "::Indra 2:IN2_GeneralProcedures", version>=1.63
