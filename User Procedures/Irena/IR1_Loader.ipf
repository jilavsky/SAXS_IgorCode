...
#include ":IR1_Main", version>=2.64
//#include ":IR1_Panel", version>=2.03
//#include ":IR1_Recording", version>=2.03
#include ":IR1_ScattContr_New", version>=2.26
#include ":IR1_Sizes", version>=2.24
//#include ":IR1_SupportFncts", version>=2.03
#include ":IR1_Unified_Fit_Fncts", version>=2.19
#include ":IR1_Unified_Fit_Fncts2", version>=2.06
#include ":IR1_Unified_Panel", version>=2.22
#include ":IR1_Unified_Panel_Fncts", version>=2.23
#include ":IR1_Unified_SaveExport", version>=2.02
#include ":IR1_UnifiedSavetoXLS", version>=2.01
#include ":IR2_dataMiner", version >=1.12
#include ":IR2_GelsTool", version>=4.12
#include ":IR2_PanelCntrlProcs", version>=1.44
#include ":IR2_Reflectivity", version >=1.19
#include ":IR2_ScriptingTool", version>=1.28
#include ":IR2_SmallAngleDiff", version>=1.16
#include ":IR2_StructureFactors", version>=1.07
#include ":IR2_UniversalDataExport", version>=1.09
#include ":IR2L_NLSQFCalc", version>=1.14
#include ":IR2L_NLSQFfunctions", version>=1.24
#include ":IR2L_NLSQFmain", version>=1.22
#include ":IR2L_NLSQFsupport", version>=1.41
