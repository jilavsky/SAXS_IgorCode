...
#include ":IN2_GeneralProcedures", version>=1.62
...
#include ":IN2_SpecInput", version>=1.17
#include ":IN2_Standard Plots", version>=1.13
#include ":IN2_USAXS", version>=1.28
#include ":IN2_XtalCalculationsP", version>=1

#include ":IN3_CalcScattering", version>=1
#include ":IN3_Calculations", version>=1.02
#include ":IN3_Main", version>=1.77
...
#include "::Irena:IR2_PanelCntrlProcs", version>=1.15
