...
Window IN2Y_ChannelCutPosCalculations() : Panel
	...
	SetVariable BraggAngle, fSize=14, format="%3.6f"
...
Function IN2Y_PopProcedure(string ctrlName, variable popNum, string popStr) : PopupMenuControl
...
Function IN2Y_XtalCalculations(string ctrlName, variable varNum, string varStr, string varName) : SetVariableControl
