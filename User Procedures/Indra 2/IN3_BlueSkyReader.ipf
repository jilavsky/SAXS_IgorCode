...
//**************************************************************************************
//************************************************************************************************************
Function IN3BS_ListBoxMenuProc(STRUCT WMListboxAction &lba) : ListBoxControl
...
Function IR3BS_SetVarProc(STRUCT WMSetVariableAction &sva) : SetVariableControl
...
Function IR3BS_ButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function IR3BS_GetJSONScanData()
	...
	variable i
	variable done = 0
	variable numDataSets, i2, j
	variable Oldrecords = 0
...
//************************************************************************************************************
//************************************************************************************************************
Function IR3S_CheckProc(STRUCT WMCheckboxAction &cba) : CheckBoxControl
...
//************************************************************************************************************
//************************************************************************************************************
Function IR3BS_PopMenuProc(STRUCT WMPopupAction &pa) : PopupMenuControl
...
threadsafe static Function JSON_GetArraySize(variable jsonID, string jsonPath, [variable ignoreErr])
...
threadsafe static Function/S JSON_GetString(variable jsonID, string jsonPath, [variable ignoreErr])
...
threadsafe static Function JSON_GetVariable(variable jsonID, string jsonPath, [variable ignoreErr])
...
threadsafe static Function/WAVE JSON_GetWave(variable jsonID, string jsonPath, [variable ignoreErr])
...
threadsafe static Function/WAVE JSON_GetKeys(variable jsonID, string jsonPath, [variable esc, variable ignoreErr])
...
threadsafe static Function/WAVE JSON_GetMaxArraySize(variable jsonID, string jsonPath, [variable ignoreErr])
