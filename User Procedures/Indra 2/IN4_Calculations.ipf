...
Function IN4_FitModGaussTop(string Foldername) // uses Modfied Gaussian
	...
	T_Constraints[2] = {"K2<0.003"}	//this relatively large number is needed to make sure the fits work for MSAXS data
...
Function IN4_FindQminForUSAXS(string Foldername)
	...
	variable Qmin
	NVAR MinQMinFindRatio = root:Packages:Indra4:USAXSMinQMinFindRatio
...
Function IN4_RebinDataIfNeeded(string Foldername)
	...
	NVAR  FlyScanRebinToPoints = root:Packages:Indra4:USAXSFSNumPoints
