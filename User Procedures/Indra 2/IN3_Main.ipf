...
Function IN3_MainPanelNew()
	...
	SetVariable RemoveDropoutsTime, pos={220, 665}, size={180, 22}, title="Drpt. Time [s] =", frame=1, disable=!disableMe
	...
	SetVariable RemoveDropoutsFraction, pos={220, 685}, size={180, 22}, title="Drp Int. fract. (0.1-0.7) =", frame=1, disable=!disableMe
...
//*****************************************************************************************************************
//*****************************************************************************************************************
Function IN3_FailedLoadMessage(string Filename) : Panel
...
Function/S IN3_USAXSScanLoadHdf5File2(variable LoadManyDataSets)
	...
	for(i = 0; i < numpnts(WaveOfSelections); i += 1)
		if(WaveOfSelections[i] && (LoadManyDataSets || NumOpenedFiles < 1))
			...
			WAVE/Z/T program_name = $(HDF5RawFolderWithData + "entry:program_name")
...
//***********************************************************
//***********************************************************
Function IN3_KillPrefsButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
