...
#include ":NI1_BeamCenterUtils",version>=2.28
#include ":NI1_ConvProc", version>=2.65
#include ":NI1_DNDCATsupport",version>=1.11
#include ":NI1_FileLoaders",version>=2.49
#include ":NI1_FITSLoader",version>=2.17
#include ":NI1_HDF5Browser",version>=1.01
#include ":NI1_InstrumentSupport",version>=1.20
#include ":NI1_LineProfile", version>=2.04
#include ":NI1_Main", version>=1.81
#include ":NI1_MainPanel", version>=2.61
...
#include ":NI1_USAXSSupport",version>=1.49
