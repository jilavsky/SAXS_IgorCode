...
#include "NI1_ConvProc", version>=2.70
#include "NI1_DNDCATsupport",version>=1.12
#include "NI1_FileLoaders",version>=2.52
...
#include "NI1_Main", version>=1.83
#include "NI1_MainPanel", version>=2.69
...
#include "NI1_USAXSSupport",version>=1.52
