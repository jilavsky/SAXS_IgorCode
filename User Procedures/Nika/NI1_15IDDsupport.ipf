...
//*************************************************************************\
//* Copyright (c) 2005 - 2011, Argonne National Laboratory
...
Function NI1_15IDDCreateHelpNbk()
	...
	Notebook $nb text="5. \tCreate mask to mask off the bad points using button: \"Create bad pix mask\")\r"
	...
	Notebook $nb text="lting data will be \"_270_10\"). Likely choose \"Delete temp Data\" if you are creating slit smeared data.\r"
	...
	Notebook $nb text="270_10\" data with USAXS desmeared data. \r"
	Notebook $nb text="\r"
	Notebook $nb text="\r"
