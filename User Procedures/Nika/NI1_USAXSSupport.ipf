...
//		Notebook $nb text="5. \tCreate mask to mask off the top few lines on detector using button: \"Create SAXS/WAXS mask\"\r"
		...
		Notebook $nb ruler=Normal, text="1.\tSelect \"WAXS-Pilatus\" checkbox. Check or keep checked the checkbox \"Read Parameters from files\".\r"
		Notebook $nb text="ONLY if you are told by staff, specifically, that you have Dexela, use WAXS-Dexela. If you do not know, you have Pilatus.\r"
		Notebook $nb text="\r"
		Notebook $nb text="2.\tPush \"Set default settings\" button to locate one representative 2D image (.hdf) file inside the data "
